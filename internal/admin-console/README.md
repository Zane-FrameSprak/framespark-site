...
截至 2026-06-18，控制台状态栏已同步到当前生产阶段：

- Diagnosis Beta invite-code 已上线，普通测试者通过首页内测码入口进入。
- 当前首批真实内测码为 5 个，每码默认 7 天有效、最多 5 次成功验证。
- B4 72 小时观测尚未启动；真实诊断扩量、DeepSeek 调用和费用观察需要单独确认。
