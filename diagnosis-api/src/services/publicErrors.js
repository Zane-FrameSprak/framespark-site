const PUBLIC_ERRORS = Object.freeze({
  ...
  TEXT_TOO_LONG: [413, '材料超过当前内测支持的长度。'],
  FILE_TOO_LARGE: [413, '文件超过当前内测支持的大小。'],
