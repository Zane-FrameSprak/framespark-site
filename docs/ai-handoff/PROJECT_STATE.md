...
- `patch3b` local tests pass, but its final hard guard has not received another real-AI regression because the task call budget was exhausted. See `docs/diagnosis/V1_FINAL_PATCH3_REGRESSION_2026-06-10.md`.
